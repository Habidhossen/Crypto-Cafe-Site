...
const CoinDetail = () => {
  ...
  return (
    <div className="px-4 pt-20 pb-24 mx-auto max-w-7xl md:px-2">
      <div className="bg-stone-800 text-white px-5 rounded-lg shadow-lg py-10 h-full grid grid-cols-1 md:grid-cols-2 justify-items-center gap-4 md:justify-items-around content-center">
        <div className="order-2 md:order-1">
          ...
          <h1 className="text-2xl font-semibold mt-4">Scores:</h1>
          <hr />
