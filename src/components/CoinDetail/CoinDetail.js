    ...
    <>
      {loader ? (
        ...
        <div className="px-4 pt-20 pb-24 mx-auto max-w-7xl md:px-2">
          <div className="px-5 rounded-lg shadow-lg py-10 h-full grid grid-cols-1 md:grid-cols-2 justify-items-center gap-4 md:justify-items-around content-center">
