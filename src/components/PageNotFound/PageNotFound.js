    ...
    <section className="px-4 py-32 mx-auto max-w-7xl">
      <div className="grid items-center w-full grid-cols-1 gap-10 mx-auto md:w-4/5 lg:grid-cols-2 xl:gap-32">
        <div>
          ...
          <Link
            to="/"
            className="w-full mb-2 py-2 px-3 text-white mt-3 bg-purple-800 sm:w-auto sm:mb-0"
          >
            Back to homepage
          </Link>
          <Link
            to="/contact"
            className="w-full mb-2 py-2 px-3 text-white mt-3 mx-2 bg-purple-800 sm:w-auto sm:mb-0"
          >
            Contact us
          </Link>
        </div>
